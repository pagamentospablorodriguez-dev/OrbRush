...
function App() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-slate-950 select-none">
      ...
      {/* Mute button */}
<button onClick={toggleMute} className="absolute top-3 right-3 translate-y-[50px] z-50 w-9 h-9 rounded-full bg-slate-800/80 border border-slate-700 flex items-center justify-center text-slate-300 hover:text-white hover:bg-slate-700 transition-colors">
