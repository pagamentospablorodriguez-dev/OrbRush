...
export const STRIPE_TEMPTATION_URL = "https://buy.stripe.com/test_temptation_299";
export const STRIPE_FIRST_GAMEOVER_URL = "https://buy.stripe.com/test_first_gameover_099";
...
// Check URL for activation code on load.
export function checkUrlActivation(): boolean {
  try {
    ...
    // New Monetization Activation (e.g., ?activate=2x_points)
